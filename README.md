...
result_one: bool = weekdays is not nums
result_two: bool = weekdays != nums

print(result_one)  # True
print(result_two)  # False
```
...
Операторы идентичности часто используются в объектно-ориентированном программировании.
И их правильное использование показывает опыт разработчика; не стоит пренебрегать 
использованием этого оператора. Иногда важно проверять только значение объектов, а не их 
